...
::: callout-important
**NOTE:** This class is listed as a hybrid online class with some synchronous meetings throughout the semester (see @sec-schedule below). The first meeting (**August 17th**) is mandatory. From there, the rest are optional. However, one person from each group must attend.
:::
...
The group assignment will have four deliverables: 1) a group roles contract (details will be provided on Brightspace) submitted for instructor review (due **September 29th**); 2) an outline of the group's approach to the selected case (due **October 13th**); 3) the final research report (due **December 10th**); and 4) a group final presentation and a polished presentation from all members (due **December 10th**).
