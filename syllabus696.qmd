...
::: callout-important
**NOTE:** This class is listed as a hybrid online class with some synchronous meetings throughout the semester (see @sec-schedule below). The first meeting (**August 27th**) is mandatory. From there, the rest are optional. However, one person from each group must attend.
:::
...
1.  An individual assignment to produce a report demonstrating compentency in a broad range of MPA-related skills.
2.  A group assignment to produce a final report on a salient policy and administration issue that demonstrates all MPA competencies.

Unlike most courses, this course is ensuring an application and synthesis of program skills and materials. As a result, there are not weekly modules and not necessarily new skills or content taught week to week. Instead, we will follow a biweekly meeting schedule (see detailed course schedule below) and most meetings will allow for groups to coordinate their work and ask any questions they might have of the instructor.

## Assignments

### Individual Assignment

For the individual assignment, students are expected to write a brief (2 pages) summarizing a detailed and well-researched stakeholder assessment and management plan for the administrative problem outlined in the individual assignment materials. This memo will be due **October 13th** alongside your 1-page outline of your plan for your group assignment.

In addition, you will need to complete peer evaluations of each of your group mates (due **December 12th**; details provided during the course via Brightspace) and complete the MPA Exit Survey (dur **December 12th**; details provided during the course via Brightspace).

### Group Assignment

The group assignment will have four deliverables: 1) a group roles contract (details will be provided on Brightspace) submitted for instructor review (due **September 24th**); 2) an outline of the group's approach to the selected case (first draft due **October 5th**; due **October 13th**); 3) the final research report (due **December 10th**); and 4) a group final presentation and a polished presentation from all members (due **December 10th**).
...
- Complete exit survey: 5 points

## Detailed Course Schedule {#sec-schedule}

| Date  |                  Assignment                   | Readings |
|:-----:|:---------------------------------------------:|:--------:|
| 8/27  |    First class - Introduction and Syllabus    |          |
| 9/10  | Group Roles Contract and Client Selection Due |          |
| 9/24  |          Writing Literature Reviews           |          |
| 10/8  |       1-page outline of group appraoch        |          |
| 10/22 |      Comparing Alternatives and Analysis      |          |
| 11/5  |      Stakeholders and Political Analysis      |          |
| 12/10 |    Final presentations, final reports due     |          |
